...
public class ChessScene extends Stage {
    ...
    ChessScene(int sideLen, String startPos) throws CloneNotSupportedException {
        ...
        try {
            ...
            this.controller.setPlayers(controller, new BatchChessBot(new AlphaNet(ModelSerializer.restoreComputationGraph("boardsNBots/bots/networks/Full_GameStockFish_5_checkPoint.zip")),"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 420));
